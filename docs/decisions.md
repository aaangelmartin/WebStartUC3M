...
- Los tiers de patrocinio pasan de 3 (Partner/Patrocinio de evento/Colaborador) a **2**: **Partner de Temporada** (oferta ancla, 2-3 plazas por curso, acompaña toda la temporada) y **patrocinio de evento** (rampa de entrada, un evento concreto, dinero o en especie). El tier "Colaborador" desaparece del modelo de precios; los colaboradores en especie que ya existen (TeamLabs, Madrid Startup Bar, etc.) se siguen mostrando como categoría propia en `/patrocinadores`, pero ya no como algo que se vende con precio.
