...
Issue #26. Especificación de contenido, no los archivos — bloqueados por el design system en Pencil (#2). Cuando exista, producir en `public/og/` a 1200×630px.

## Plantilla base
Fondo cobalto `#2B3A91` (o variante navy según dirección B de `docs/research.md`), logo `start_` en esquina, tipografía grande (Anton/grotesk condensada según dirección elegida), cursor `_` como elemento de marca.

| Página | Texto principal | Texto secundario |
|---|---|---|
